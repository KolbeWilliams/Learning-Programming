...
--departments: department_name (PK), location_id (FK)
--employees: employee_id (PK), first_name, last_name, email, phone_number, hire_date, job_id (FK), salary, manager_id (FK), department_name (FK)
--dependents: dependent_id (PK), first_name, last_name, relationship, employee_id
...
ADD CONSTRAINT FK_Department  -- Optional: Add a constraint name for better management
